...
export function TableOverlay({ tables, teamName, onClose }: TableOverlayProps) {
  ...
  return (
    <div className="table-overlay-backdrop" onClick={handleBackdropClick}>
      <div className="table-overlay-content" role="dialog" aria-modal="true" aria-label={`Tabell for ${teamName}`}>
